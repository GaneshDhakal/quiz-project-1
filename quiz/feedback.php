        ...
        <div class="col-md-6 panel" style="background-image:url(image/bg1.jpg); min-height:430px;">
            ...
            <div style="font-size:14px">
                <?php if (@$_GET['q']) echo '<span style="font-size:18px;"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span>&nbsp;' . @$_GET['q'] . '</span>';
                    ...
                    <input id="subject" name="subject" placeholder="Enter subject" class="form-control input-md" type="text"  required="required">
                    </div>
                    </div>
                    </div><!--End of row-->
                    ...
                    <!-- Text input-->
                    <div class="form-group">
                    <input id="email" name="email" value="ganeshd793536@gmail.com" class="form-control input-md" type="email"  required="required" readonly>
                    </div>
                    </div>
                    </div><!--End of row-->

                    <div class="form-group">
                    <textarea rows="5" cols="8" name="feedback" class="form-control" placeholder="Write feedback here..."  required="required"></textarea>
                    </div>
