...
if (mob == null || mob == "") {
    ...
    alert("Mobile number must contain at least 10 digits.");
    return false;
}
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="mob" name="mob" placeholder="Enter your mobile number" class="form-control input-md" inputmode="numeric" type="number" minlength="10"
  style="-webkit-appearance: none; appearance: none; margin: 0;" >
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		 ...
		 <div class="col-md-5">
		<a href="http://yugeshverma.blogspot.in" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">GANESH DHAKAL</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">9748819582</h4>
		<h4 style="font-family:'typo' ">ganeshd793536@gmail.com</h4>
		<h4 style="font-family:'typo' ">lumbini city</h4></div></div>
		</p>
      </div>
